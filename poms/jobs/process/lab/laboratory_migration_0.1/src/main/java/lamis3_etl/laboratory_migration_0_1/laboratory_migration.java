...
int count_tDBOutput_1=0;
	    String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"" + "date_created" + "\" = " + "now()" + ",\"date_visit_start\" = ?,\"" + "time_visit_start" + "\" = " + "now()" + ",\"date_visit_end\" = ?,\"organisation_unit_id\" = ?,\"patient_id\" = ?,\"archived\" = ?,\"created_by\" = ? WHERE \"date_visit_start\" = ? AND \"organisation_unit_id\" = ? AND \"patient_id\" = ?";
	    java.sql.PreparedStatement pstmtUpdate_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(update_tDBOutput_1);
	    resourceMap.put("pstmtUpdate_tDBOutput_1", pstmtUpdate_tDBOutput_1);
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"" + "date_created" + "\",\"date_visit_start\",\"" + "time_visit_start" + "\",\"date_visit_end\",\"organisation_unit_id\",\"patient_id\",\"archived\",\"created_by\") VALUES (" + "now()" + ",?," + "now()" + ",?,?,?,?,?)";
...
pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.TIMESTAMP);
                    ...
                    pstmtUpdate_tDBOutput_1.setLong(3, visit_create.organisation_unit_id);
                        ...
                        query_tDBOutput_1 = query_tDBOutput_1.append(String.valueOf(visit_create.organisation_unit_id)).append(updateSQLSplits_tDBOutput_1[3]);
                    pstmtUpdate_tDBOutput_1.setLong(4, visit_create.patient_id);

                        query_tDBOutput_1 = query_tDBOutput_1.append(String.valueOf(visit_create.patient_id)).append(updateSQLSplits_tDBOutput_1[4]);
                    if(visit_create.archived == null) {
pstmtUpdate_tDBOutput_1.setNull(5, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setInt(5, visit_create.archived);
}

                        query_tDBOutput_1 = query_tDBOutput_1.append(visit_create.archived== null ?  "null" :String.valueOf(visit_create.archived)).append(updateSQLSplits_tDBOutput_1[5]);
                    if(visit_create.created_by == null) {
pstmtUpdate_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(6, visit_create.created_by);
}

                        query_tDBOutput_1 = query_tDBOutput_1.append(visit_create.created_by== null ?  "null" :"'" + visit_create.created_by + "'").append(updateSQLSplits_tDBOutput_1[6]);
...
pstmtUpdate_tDBOutput_1.setNull(7 + count_tDBOutput_1, java.sql.Types.TIMESTAMP);
                    ...
                    pstmtUpdate_tDBOutput_1.setLong(8 + count_tDBOutput_1, visit_create.organisation_unit_id);
						...
						query_tDBOutput_1 = query_tDBOutput_1.append(String.valueOf(visit_create.organisation_unit_id)).append(updateSQLSplits_tDBOutput_1[8]);
					

                    pstmtUpdate_tDBOutput_1.setLong(9 + count_tDBOutput_1, visit_create.patient_id);

						query_tDBOutput_1 = query_tDBOutput_1.append(String.valueOf(visit_create.patient_id)).append(updateSQLSplits_tDBOutput_1[9]);
...
pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.TIMESTAMP);
                        ...
                        pstmtInsert_tDBOutput_1.setLong(3, visit_create.organisation_unit_id);
                            ...
                            query_tDBOutput_1 = query_tDBOutput_1.append(String.valueOf(visit_create.organisation_unit_id)).append(insertSQLSplits_tDBOutput_1[3]);
                        pstmtInsert_tDBOutput_1.setLong(4, visit_create.patient_id);

                            query_tDBOutput_1 = query_tDBOutput_1.append(String.valueOf(visit_create.patient_id)).append(insertSQLSplits_tDBOutput_1[4]);
                        if(visit_create.archived == null) {
pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setInt(5, visit_create.archived);
}

                            query_tDBOutput_1 = query_tDBOutput_1.append(visit_create.archived== null ?  "null" :String.valueOf(visit_create.archived)).append(insertSQLSplits_tDBOutput_1[5]);
                        if(visit_create.created_by == null) {
pstmtInsert_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(6, visit_create.created_by);
}

                            query_tDBOutput_1 = query_tDBOutput_1.append(visit_create.created_by== null ?  "null" :"'" + visit_create.created_by + "'").append(insertSQLSplits_tDBOutput_1[6]);
                    globalMap.put("tDBOutput_1_QUERY", query_tDBOutput_1.toString().trim());
...
int count_tDBOutput_2=0;
	    String update_tDBOutput_2 = "UPDATE \"" + tableName_tDBOutput_2 + "\" SET \"" + "date_created" + "\" = " + "now()" + ",\"visit_id\" = ?,\"date_encounter\" = ?,\"form_code\" = ?,\"program_code\" = ?,\"created_by\" = ?,\"patient_id\" = ?,\"organisation_unit_id\" = ?,\"archived\" = ? WHERE \"visit_id\" = ? AND \"date_encounter\" = ? AND \"form_code\" = ? AND \"patient_id\" = ?";
 					    ...
 					    boolean forceLooprow5 = false;
 							...
 							row5Struct row5ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_2 = false;
                        		    		    ...
                        		    		    row5HashKey.date_visit_start = row4.sample_date  == null ? null : new java.util.Date(row4.sample_date .getTime());
...
pstmtUpdate_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
                    ...
                    if(out1.date_encounter != null) {
pstmtUpdate_tDBOutput_2.setTimestamp(10 + count_tDBOutput_2, new java.sql.Timestamp(out1.date_encounter.getTime()));
} else {
...
} else {pstmtUpdate_tDBOutput_2.setString(11 + count_tDBOutput_2, out1.form_code);
}
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("laboratory_not_migrated.csv")).getAbsolutePath().replace("\\","/");
            ...
            csvSettings_tFileOutputDelimited_1.setEscapeAndTextEnclosure("\"","\"");
                    ...
                    if(!csvSettings_tFileOutputDelimited_1.isUseCRLFRecordDelimiter() && csvSettings_tFileOutputDelimited_1.getRowDelim()!='\r' && csvSettings_tFileOutputDelimited_1.getRowDelim()!='\n') {
                        ...
                        if(filetFileOutputDelimited_1.length()==0){
                                    ...
                                    headColutFileOutputDelimited_1[7]="test_name";
                                    headColutFileOutputDelimited_1[8]="lab_test_id";
 					    ...
 					    boolean forceLooprow7 = false;
 							...
 							row7Struct row7ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_3 = false;
                        		    		    ...
                        		    		    row7HashKey.date_encounter = row6.sample_date  == null ? null : new java.util.Date(row6.sample_date .getTime());
 					    ...
 					    boolean forceLooprow8 = false;
 							...
 							row8Struct row8ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_3 = false;
                        		    		    ...
                        		    		    row8HashKey.test_name = row6.test_name.replace("K+", "POTASSIUM  K+")
.replace("TRIGLYCERIDE", "TRIGLYCERIDES")
.replace("CL-", "CHLORIDE CL-") ;
								  ...
								  if(!tHash_Lookup_row8.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row8 != null && tHash_Lookup_row8.getCount(row8HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row8' and it contains more one result from keys :  row8.test_name = '" + row8HashKey.test_name + "'");
								} // G 071
...
form_data_reject_tmp.test_name = row6.test_name ;
form_data_reject_tmp.lab_test_id = row6.lab_test_id ;
...
json.put("sample_order_date", form_data_to_create.sample_date != null ? formatter.format(form_data_to_create.sample_date) : JSONObject.NULL );
json.put("date_result_reported", form_data_to_create.date_result_received != null ? formatter.format(form_data_to_create.date_result_received) : JSONObject.NULL);
...
if(form_data_to_create.indication != null){
    ...
    status = status.equalsIgnoreCase("Routine Monitoring") ? "Routine (every 12 months)" : status;
	//status = status.equalsIgnoreCase("Targeted Monitoring") ? "Routine (every 12 months)" : status;

	JSONObject item = null;
	for(int x = 0; x < vlIndications.length(); x++){
		if(vlIndications.getJSONObject(x).getString("display").equalsIgnoreCase(status)){
	...
	if(item != null){
		...
		context.application_codeset_not_present = context.application_codeset_not_present + (context.application_codeset_not_present != null && context.application_codeset_not_present != "" ? ",'" : "'") +"viral_load_indication - "+ status + "'";
	}
...
item.put("date_result_reported", form_data_to_create.date_result_received != null ? formatter.format(form_data_to_create.date_result_received) : JSONObject.NULL);
								...
								hasCasePrimitiveKeyWithNull_tMap_4 = false;
								  ...
								  if(!tHash_Lookup_row11.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row11 != null && tHash_Lookup_row11.getCount(row11HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row11' and it contains more one result from keys :  row11.encounter_id = '" + row11HashKey.encounter_id + "', row11.lab_test_id = '" + row11HashKey.lab_test_id + "'");
								} // G 071
	...
	currentComponent="tFileOutputDelimited_1";
					...
					if(execStat){
                        ...
                        String[] rowtFileOutputDelimited_1=new String[9];
                            ...
                            rowtFileOutputDelimited_1[3]=form_data_reject.lines == null ? null : form_data_reject.lines;
                            rowtFileOutputDelimited_1[4]=form_data_reject.date_result_received == null ? null : FormatterUtils.format_Date(form_data_reject.date_result_received, "yyyy-MM-dd");
                            rowtFileOutputDelimited_1[5]=form_data_reject.date_sample_collected == null ? null : FormatterUtils.format_Date(form_data_reject.date_sample_collected, "yyyy-MM-dd");
                            rowtFileOutputDelimited_1[6]=form_data_reject.reason == null ? null : form_data_reject.reason;
                            rowtFileOutputDelimited_1[7]=form_data_reject.test_name == null ? null : form_data_reject.test_name;
                            rowtFileOutputDelimited_1[8]=form_data_reject.lab_test_id == null ? null : form_data_reject.lab_test_id;
...
System.out.println("*******************LABORATORY MIGRATION COMPLETED*********************************");
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row7";
		...
		int tos_count_tAdvancedHash_row7 = 0;
			   		...
			   		// linked node: tMap_3 - inputs:(row6,row7,row8,row9) outputs:(form_data_to_create,form_data_reject)
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = laboratory_migration.class.getClassLoader().getResourceAsStream("lamis3_etl/laboratory_migration_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = laboratory_migration.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : laboratory_migration");
        }
...
/************************************************************************************************
 *     364350 characters generated by Talend Open Studio for Big Data 
 *     on the June 22, 2021 3:04:53 PM WAT
 ************************************************************************************************/