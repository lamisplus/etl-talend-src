...
package lamis3_etl.client_status_migration_0_1;
...
/**
 * Job: client_status_migration Purpose: To migrate EAC records<br>
 * Description: To migrate EAC records <br>
 * @author deborah.obanisola@thepalladiumgroup.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class client_status_migration implements TalendJob {
...
public String getLAMISPlus_Port(){
	...
	private final String jobName = "client_status_migration";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				client_status_migration.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(client_status_migration.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
System.out.println("****************CLIENT STATUS MIGRATION****************");
System.out.println("To migrate records the following tables will be affected on LAMISPlus:");
...
public static class visit_createStruct implements routines.system.IPersistableRow<visit_createStruct> {
    final static byte[] commonByteArrayLock_LAMIS3_ETL_client_status_migration = new byte[0];
    static byte[] commonByteArray_LAMIS3_ETL_client_status_migration = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LAMIS3_ETL_client_status_migration.length) {
				if(length < 1024 && commonByteArray_LAMIS3_ETL_client_status_migration.length == 0) {
   					commonByteArray_LAMIS3_ETL_client_status_migration = new byte[1024];
				} else {
   					commonByteArray_LAMIS3_ETL_client_status_migration = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LAMIS3_ETL_client_status_migration, 0, length);
			strReturn = new String(commonByteArray_LAMIS3_ETL_client_status_migration, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LAMIS3_ETL_client_status_migration) {
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    static byte[] commonByteArray_LAMIS3_ETL_client_status_migration = new byte[0];
			    ...
			    public java.util.Date date_status;

				public java.util.Date getDate_status () {
			    ...
			    public java.util.Date date_tracked;

				public java.util.Date getDate_tracked () {
					return this.date_tracked;
				}
		...
		synchronized(commonByteArrayLock_LAMIS3_ETL_client_status_migration) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.date_status = readDate(dis);
					
					this.outcome = readString(dis);
					
					this.agreed_date = readDate(dis);
					
					this.reason_for_interruption = readString(dis);
					
					this.date_tracked = readDate(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// java.util.Date
						...
						writeDate(this.date_status,dos);
					
					// String
				
						writeString(this.outcome,dos);
					...
					// java.util.Date
						...
						writeDate(this.date_tracked,dos);
    ...
    public String toString() {
		...
		sb.append(",date_status="+String.valueOf(date_status));
		...
		sb.append(",date_tracked="+String.valueOf(date_tracked));
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = context.LAMIS3_Password; 
		    ...
		    String dbquery_tDBInput_1 = "select p.uuid as patient_uuid, s.status, s.date_status, s.outcome, s.agreed_date, s.reason_for_interruption,\ns.date_tr"
+"acked, s.cause_of_death, s.archived, s.uuid, s.auto\nfrom status_history s\njoin patient p on s.patient_id = p.id\nwhere"
+" s.auto = false\n--and p.facility_id = 2304\n";
        	...
        	row1.status = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row1.date_status = null;
							} else {
										
			row1.date_status = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 3);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row1.outcome = null;
							} else {
	                         		
        	row1.outcome = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 5) {
								row1.agreed_date = null;
							} else {
										
			row1.agreed_date = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 5);
		                    }
							if(colQtyInRs_tDBInput_1 < 6) {
								row1.reason_for_interruption = null;
							} else {
	                         		
        	row1.reason_for_interruption = routines.system.JDBCUtil.getString(rs_tDBInput_1, 6, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 7) {
								row1.date_tracked = null;
							} else {
										
			row1.date_tracked = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 7);
		                    }
							if(colQtyInRs_tDBInput_1 < 8) {
								row1.cause_of_death = null;
							} else {
	                         		
        	row1.cause_of_death = routines.system.JDBCUtil.getString(rs_tDBInput_1, 8, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 9) {
								row1.archived = null;
							} else {
	                         		
            row1.archived = rs_tDBInput_1.getBoolean(9);
        	...
        	row1.uuid = routines.system.JDBCUtil.getString(rs_tDBInput_1, 10, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 11) {
								row1.auto = false;
							} else {
	                         		
            row1.auto = rs_tDBInput_1.getBoolean(11);
            if(rs_tDBInput_1.wasNull()){
...
visit_create_tmp.date_visit_start = row1.date_status;
visit_create_tmp.date_visit_end = row1.date_status;
 ...
 */
	...
	final String decryptedPassword_tDBInput_4 = context.LAMIS3_Password; 
		    ...
		    String dbquery_tDBInput_4 = "select p.uuid as patient_uuid, s.status, s.date_status, s.outcome, s.agreed_date, s.reason_for_interruption,\ns.date_tr"
+"acked, s.cause_of_death, s.archived, s.uuid, s.auto\nfrom status_history s\njoin patient p on s.patient_id = p.id\nwhere"
+" s.auto = false\n--and p.facility_id = 2304\n";
        	...
        	row4.status = routines.system.JDBCUtil.getString(rs_tDBInput_4, 2, false);
		                    }
							if(colQtyInRs_tDBInput_4 < 3) {
								row4.date_status = null;
							} else {
										
			row4.date_status = routines.system.JDBCUtil.getDate(rs_tDBInput_4, 3);
		                    }
							if(colQtyInRs_tDBInput_4 < 4) {
								row4.outcome = null;
							} else {
	                         		
        	row4.outcome = routines.system.JDBCUtil.getString(rs_tDBInput_4, 4, false);
		                    }
							if(colQtyInRs_tDBInput_4 < 5) {
								row4.agreed_date = null;
							} else {
										
			row4.agreed_date = routines.system.JDBCUtil.getDate(rs_tDBInput_4, 5);
		                    }
							if(colQtyInRs_tDBInput_4 < 6) {
								row4.reason_for_interruption = null;
							} else {
	                         		
        	row4.reason_for_interruption = routines.system.JDBCUtil.getString(rs_tDBInput_4, 6, false);
		                    }
							if(colQtyInRs_tDBInput_4 < 7) {
								row4.date_tracked = null;
							} else {
										
			row4.date_tracked = routines.system.JDBCUtil.getDate(rs_tDBInput_4, 7);
		                    }
							if(colQtyInRs_tDBInput_4 < 8) {
								row4.cause_of_death = null;
							} else {
	                         		
        	row4.cause_of_death = routines.system.JDBCUtil.getString(rs_tDBInput_4, 8, false);
		                    }
							if(colQtyInRs_tDBInput_4 < 9) {
								row4.archived = null;
							} else {
	                         		
            row4.archived = rs_tDBInput_4.getBoolean(9);
        	...
        	row4.uuid = routines.system.JDBCUtil.getString(rs_tDBInput_4, 10, false);
		                    }
							if(colQtyInRs_tDBInput_4 < 11) {
								row4.auto = false;
							} else {
	                         		
            row4.auto = rs_tDBInput_4.getBoolean(11);
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 					    ...
 					    boolean forceLooprow5 = false;
 							...
 							row5Struct row5ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row5HashKey.date_visit_start = row4.date_status == null ? null : new java.util.Date(row4.date_status.getTime());
...
out1_tmp.form_code = "5210f079-27e9-4d01-a713-a2c400e0926c";
...
public static class form_data_to_createStruct implements routines.system.IPersistableRow<form_data_to_createStruct> {
    ...
    static byte[] commonByteArray_LAMIS3_ETL_client_status_migration = new byte[0];
			    ...
			    public String death_application_codeset;

				public String getDeath_application_codeset () {
					return this.death_application_codeset;
				}
				
			    public String interuptn_application_codeset;

				public String getInteruptn_application_codeset () {
					return this.interuptn_application_codeset;
				}
			    ...
			    public String tracking_outcome_application_codeset;

				public String getTracking_outcome_application_codeset () {
					return this.tracking_outcome_application_codeset;
				}
		...
		synchronized(commonByteArrayLock_LAMIS3_ETL_client_status_migration) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.death_application_codeset = readString(dis);
					
					this.interuptn_application_codeset = readString(dis);
					
					this.status_application_codeset = readString(dis);
					
					this.tracking_outcome_application_codeset = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.death_application_codeset,dos);
					
					// String
				
						writeString(this.interuptn_application_codeset,dos);
					...
					// String
						...
						writeString(this.tracking_outcome_application_codeset,dos);
    ...
    public String toString() {
		...
		sb.append(",patient_id="+String.valueOf(patient_id));
		sb.append(",uuid="+uuid);
		sb.append(",death_application_codeset="+death_application_codeset);
		sb.append(",interuptn_application_codeset="+interuptn_application_codeset);
		sb.append(",status_application_codeset="+status_application_codeset);
		sb.append(",tracking_outcome_application_codeset="+tracking_outcome_application_codeset);
		sb.append(",status="+status);
		sb.append(",outcome="+outcome);
		sb.append(",agreed_date="+String.valueOf(agreed_date));
		sb.append(",reason_for_interruption="+reason_for_interruption);
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("client_status_not_migrated.csv")).getAbsolutePath().replace("\\","/");
 ...
 */
	...
	final String decryptedPassword_tDBInput_6 = context.LAMIS3_Password; 
		    ...
		    String dbquery_tDBInput_6 = "select p.uuid as patient_uuid, s.status, s.date_status, s.outcome, s.agreed_date, s.reason_for_interruption,\ns.date_tr"
+"acked, s.cause_of_death, s.archived, s.uuid, s.auto\nfrom status_history s\njoin patient p on s.patient_id = p.id\nwhere"
+" s.auto = false \n--and p.facility_id = 2304\n";
        	...
        	row6.status = routines.system.JDBCUtil.getString(rs_tDBInput_6, 2, false);
		                    }
							if(colQtyInRs_tDBInput_6 < 3) {
								row6.date_status = null;
							} else {
										
			row6.date_status = routines.system.JDBCUtil.getDate(rs_tDBInput_6, 3);
		                    }
							if(colQtyInRs_tDBInput_6 < 4) {
								row6.outcome = null;
							} else {
	                         		
        	row6.outcome = routines.system.JDBCUtil.getString(rs_tDBInput_6, 4, false);
		                    }
							if(colQtyInRs_tDBInput_6 < 5) {
								row6.agreed_date = null;
							} else {
										
			row6.agreed_date = routines.system.JDBCUtil.getDate(rs_tDBInput_6, 5);
		                    }
							if(colQtyInRs_tDBInput_6 < 6) {
								row6.reason_for_interruption = null;
							} else {
	                         		
        	row6.reason_for_interruption = routines.system.JDBCUtil.getString(rs_tDBInput_6, 6, false);
		                    }
							if(colQtyInRs_tDBInput_6 < 7) {
								row6.date_tracked = null;
							} else {
										
			row6.date_tracked = routines.system.JDBCUtil.getDate(rs_tDBInput_6, 7);
		                    }
							if(colQtyInRs_tDBInput_6 < 8) {
								row6.cause_of_death = null;
							} else {
	                         		
        	row6.cause_of_death = routines.system.JDBCUtil.getString(rs_tDBInput_6, 8, false);
		                    }
							if(colQtyInRs_tDBInput_6 < 9) {
								row6.archived = null;
							} else {
	                         		
            row6.archived = rs_tDBInput_6.getBoolean(9);
        	...
        	row6.uuid = routines.system.JDBCUtil.getString(rs_tDBInput_6, 10, false);
		                    }
							if(colQtyInRs_tDBInput_6 < 11) {
								row6.auto = false;
							} else {
	                         		
            row6.auto = rs_tDBInput_6.getBoolean(11);
            if(rs_tDBInput_6.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 					    ...
 					    boolean forceLooprow7 = false;
 							...
 							row7Struct row7ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_3 = false;
                        		    		    ...
                        		    		    row7HashKey.date_encounter = row6.date_status == null ? null : new java.util.Date(row6.date_status.getTime());
...
form_data_to_create_tmp.death_application_codeset = row12.death_application_codeset ;
form_data_to_create_tmp.interuptn_application_codeset = row9.interuptn_application_codeset ;
form_data_to_create_tmp.status_application_codeset = row8.status_application_codeset ;
form_data_to_create_tmp.tracking_outcome_application_codeset = row2.tracking_outcome_application_codeset ;
form_data_to_create_tmp.status = row6.status ;
form_data_to_create_tmp.outcome = row6.outcome ;
form_data_to_create_tmp.agreed_date = row6.agreed_date ;
form_data_to_create_tmp.reason_for_interruption = row6.reason_for_interruption ;
form_data_to_create_tmp.date_tracked = row6.date_tracked ;
form_data_to_create_tmp.cause_of_death = row6.cause_of_death ;
form_data_to_create_tmp.auto = row6.auto ;
form_data_to_create_tmp.date_status = row6.date_status ;
...
JSONArray interuptn = new JSONArray(form_data_to_create.interuptn_application_codeset);
JSONArray death = new JSONArray(form_data_to_create.death_application_codeset);
JSONArray outcome = new JSONArray(form_data_to_create.tracking_outcome_application_codeset);

JSONObject json = new JSONObject();
json.put("date_hiv_current_status", form_data_to_create.date_status != null ? formatter.format(form_data_to_create.date_status) : JSONObject.NULL);
json.put("date_tracked", form_data_to_create.date_tracked != null ? formatter.format(form_data_to_create.date_tracked) : JSONObject.NULL);
json.put("date_agreed_return", form_data_to_create.agreed_date != null ? formatter.format(form_data_to_create.agreed_date) : JSONObject.NULL);
json.put("uuid", form_data_to_create.uuid );
json.put("auto", form_data_to_create.auto );


if(form_data_to_create.status != null && form_data_to_create.status != ""){
	String status = form_data_to_create.status;
	...
	status = status.equalsIgnoreCase("STOPPED_TREATMENT") ? "Stopped Treatment" : status;
	status = status.equalsIgnoreCase("PRE_ART_TRANSFER_OUT") ? "Pre-ART Transfer Out" : status;
	status = status.equalsIgnoreCase("LOST_TO_FOLLOWUP") ? "Lost to Follow Up" : status;
	
	status = status.equalsIgnoreCase("KNOWN_DEATH") ? "Died (Confirmed)" : status;
	status = status.equalsIgnoreCase("ART_TRANSFER_OUT") ? "ART Transfer Out" : status;
	status = status.equalsIgnoreCase("ART_RESTART") ? "ART Restart" : status;
	status = status.equalsIgnoreCase("HIV_NEGATIVE") ? "HIV Negative" : status;
	status = status.equalsIgnoreCase("ART_START") ? "ART Start" : status;
	//status = status.equalsIgnoreCase("LOST_TO_FOLLOWUP") ? "HIV Exposed Status Unknown" : status;
	...
	if(item != null){
		json.put("hiv_current_status", item);
	}else {
		context.application_codeset_not_present = context.application_codeset_not_present + (context.application_codeset_not_present != null && context.application_codeset_not_present != "" ? ",'" : "'") +"Status - "+ status + "'";
	}
}


if(form_data_to_create.reason_for_interruption != null && form_data_to_create.reason_for_interruption != ""){
	String status = form_data_to_create.reason_for_interruption;
	
	JSONObject item = null;
	for(int x = 0; x < interuptn.length(); x++){
		if(interuptn.getJSONObject(x).getString("display").equalsIgnoreCase(status)){
		item = interuptn.getJSONObject(x);
		break;
		}
	} 
	
	if(item != null){
		json.put("reason_for_interruption", item);
	}else {
		context.application_codeset_not_present = context.application_codeset_not_present + (context.application_codeset_not_present != null && context.application_codeset_not_present != "" ? ",'" : "'") +"Reason For Interruption - "+ status + "'";
	}

}

if(form_data_to_create.cause_of_death != null && form_data_to_create.cause_of_death != ""){
	String status = form_data_to_create.cause_of_death;
	JSONObject item = null;
	for(int x = 0; x < death.length(); x++){
		if(death.getJSONObject(x).getString("display").equalsIgnoreCase(status)){
		item = death.getJSONObject(x);
		break;
		}
	} 
	
	if(item != null){
		json.put("cause_death", item);
	}else {
		context.application_codeset_not_present = context.application_codeset_not_present + (context.application_codeset_not_present != null && context.application_codeset_not_present != "" ? ",'" : "'") +"Cause of Death - "+ status + "'";
	}
}

if(form_data_to_create.outcome != null && form_data_to_create.outcome != ""){
	String status = form_data_to_create.outcome;
	status = status.equalsIgnoreCase("TRACED_UNABLE_TO_LOCATE") ? "Traced Patient (Unable to locate)" : status;
	status = status.equalsIgnoreCase("TRACED_AGREED_TO_RETURN_TO_CARE") ? "Traced Patient and agreed to return to care" : status;
	JSONObject item = null;
	for(int x = 0; x < outcome.length(); x++){
		if(outcome.getJSONObject(x).getString("display").equalsIgnoreCase(status)){
		item = outcome.getJSONObject(x);
		break;
		}
	} 
	
	if(item != null){
		json.put("tracking_outcome", item);
	}else {
		context.application_codeset_not_present = context.application_codeset_not_present + (context.application_codeset_not_present != null && context.application_codeset_not_present != "" ? ",'" : "'") +"Outcome - "+ status + "'";
	}
}
...
System.out.println("*******************CLIENT STATUS MIGRATION COMPLETED*********************************");

System.out.println("*****************************************************");
System.out.println("Check ./client_status_not_migrated.csv for records that did not migrate. ");
...
+"nt p on v.patient_id = p.id\nleft join organisation_unit o on o.id = v.organisation_unit_id\nwhere v.form_code = '5210f0"
+"79-27e9-4d01-a713-a2c400e0926c'";
...
+"counter_id = e.id and e.form_code = '5210f079-27e9-4d01-a713-a2c400e0926c'";
...
+"de,'language',language) as json_object \n from application_codeset where codeset_group in ('HIV_STATUS_TXML'))) as track"
+"ing_outcome_application_codeset";
		    ...
		    while (rs_tDBInput_2.next()) {
		        nb_line_tDBInput_2++;
							...
							if(colQtyInRs_tDBInput_2 < 1) {
								row2.tracking_outcome_application_codeset = null;
							} else {
	                         		
        	row2.tracking_outcome_application_codeset = routines.system.JDBCUtil.getString(rs_tDBInput_2, 1, false);
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row2";
				...
				row2_HashRow.tracking_outcome_application_codeset = row2.tracking_outcome_application_codeset;
...
+"de,'language',language) as json_object \n from application_codeset where codeset_group in ('HIV_STATUS'))) as status_app"
+"lication_codeset ";
		    ...
		    while (rs_tDBInput_8.next()) {
		        nb_line_tDBInput_8++;
							...
							if(colQtyInRs_tDBInput_8 < 1) {
								row8.status_application_codeset = null;
							} else {
	                         		
        	row8.status_application_codeset = routines.system.JDBCUtil.getString(rs_tDBInput_8, 1, false);
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row8";
				...
				row8_HashRow.status_application_codeset = row8.status_application_codeset;
...
+"de,'language',language) as json_object \n from application_codeset where codeset_group in ('REASON_INTERRUPTION'))) as i"
+"nteruptn_application_codeset ";
		    ...
		    while (rs_tDBInput_9.next()) {
		        nb_line_tDBInput_9++;
							...
							if(colQtyInRs_tDBInput_9 < 1) {
								row9.interuptn_application_codeset = null;
							} else {
	                         		
        	row9.interuptn_application_codeset = routines.system.JDBCUtil.getString(rs_tDBInput_9, 1, false);
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row9";
				...
				row9_HashRow.interuptn_application_codeset = row9.interuptn_application_codeset;
...
+"de,'language',language) as json_object \n from application_codeset where codeset_group in ('CAUSE_DEATH'))) as death_app"
+"lication_codeset ";
		    ...
		    while (rs_tDBInput_11.next()) {
		        nb_line_tDBInput_11++;
							...
							if(colQtyInRs_tDBInput_11 < 1) {
								row12.death_application_codeset = null;
							} else {
	                         		
        	row12.death_application_codeset = routines.system.JDBCUtil.getString(rs_tDBInput_11, 1, false);
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row12";
				...
				row12_HashRow.death_application_codeset = row12.death_application_codeset;
 ...
 */
    ...
    public static void main(String[] args){
        final client_status_migration client_status_migrationClass = new client_status_migration();

        int exitCode = client_status_migrationClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = client_status_migration.class.getClassLoader().getResourceAsStream("lamis3_etl/client_status_migration_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = client_status_migration.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : client_status_migration");
        }
...
/************************************************************************************************
 *     404837 characters generated by Talend Open Studio for Big Data 
 *     on the June 22, 2021 3:03:43 PM WAT
 ************************************************************************************************/