...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    static byte[] commonByteArray_LAMIS3_ETL_clinic_followup_migration = new byte[0];
			    ...
			    public Double viral_load1;

				public Double getViral_load1 () {
					return this.viral_load1;
				}
        	...
        	try {
        		...
        		int length = 0;
					...
					this.tb_status = readString(dis);
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.viral_load1 = null;
           				} else {
           			    	this.viral_load1 = dis.readDouble();
           				}
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Double
						...
						if(this.viral_load1 == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.viral_load1);
		            	}
    ...
    public String toString() {
		...
		sb.append(",viral_load1="+String.valueOf(viral_load1));
...
int count_tDBOutput_2=0;
	    java.sql.PreparedStatement pstmt_tDBOutput_2 = conn_tDBOutput_2.prepareStatement("SELECT COUNT(1) FROM \"" + tableName_tDBOutput_2 + "\" WHERE \"date_visit_start\" = ? AND \"patient_id\" = ?");
	    resourceMap.put("pstmt_tDBOutput_2", pstmt_tDBOutput_2);
	    String insert_tDBOutput_2 = "INSERT INTO \"" + tableName_tDBOutput_2 + "\" (\"" + "time_visit_start" + "\",\"date_visit_start\",\"" + "date_created" + "\",\"date_visit_end\",\"organisation_unit_id\",\"patient_id\",\"archived\",\"created_by\") VALUES (" + "now()" + ",?," + "now()" + ",?,?,?,?,?)";
	    ...
	    String update_tDBOutput_2 = "UPDATE \"" + tableName_tDBOutput_2 + "\" SET \"" + "time_visit_start" + "\" = " + "now()" + ",\"date_visit_start\" = ?,\"" + "date_created" + "\" = " + "now()" + ",\"date_visit_end\" = ?,\"organisation_unit_id\" = ?,\"patient_id\" = ?,\"archived\" = ?,\"created_by\" = ? WHERE \"date_visit_start\" = ? AND \"patient_id\" = ?";
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = context.LAMIS3_Password; 
		    ...
		    String dbquery_tDBInput_1 = "select c.id, p.uuid, c.date_visit, c.clinic_stage, c.func_status, c.tb_status,\nc.viral_load, c.viral_load, c.cd4, c.cd"
+"4p, c.body_weight, c.height, c.waist,\nc.bp, c.lmp, c.oi_screened, c.adr_screened, c.adherence_level, c.notes, '' as use"
+"rname,\nc.sti_treated, c.gestational_age, c.maternal_status_art, c.sti_ids, c.archived, c.uuid as clinic_uuid, c.pregnan"
+"t, c.breastfeeding, c.commence, \nr.composition as regimen, rt.description as regimen_type\nfrom clinic c \njoin patient"
+" p on c.patient_id = p.id\n--join public.user u on u.user_id = c.user_id\nleft join regimen_type rt on rt.id = c.regimen"
+"_type_id\nleft join regimen r on r.id = c.regimen_id\n--where p.facility_id = 2304\n";
        	...
        	row1.uuid = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row1.date_visit = null;
							} else {
										
			row1.date_visit = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 3);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row1.clinic_stage = null;
							} else {
	                         		
        	row1.clinic_stage = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 5) {
								row1.func_status = null;
							} else {
	                         		
        	row1.func_status = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 6) {
								row1.tb_status = null;
							} else {
	                         		
        	row1.tb_status = routines.system.JDBCUtil.getString(rs_tDBInput_1, 6, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 7) {
								row1.viral_load = null;
							} else {
	                         		
            row1.viral_load = rs_tDBInput_1.getDouble(7);
            if(rs_tDBInput_1.wasNull()){
                    row1.viral_load = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 8) {
								row1.viral_load1 = null;
							} else {
	                         		
            row1.viral_load1 = rs_tDBInput_1.getDouble(8);
            if(rs_tDBInput_1.wasNull()){
                    row1.viral_load1 = null;
            }
		                    }
            ...
            row1.cd4 = rs_tDBInput_1.getDouble(9);
            if(rs_tDBInput_1.wasNull()){
                    row1.cd4 = null;
            }
		                    }
            ...
            row1.cd4p = rs_tDBInput_1.getDouble(10);
            if(rs_tDBInput_1.wasNull()){
                    row1.cd4p = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 11) {
								row1.body_weight = null;
							} else {
	                         		
            row1.body_weight = rs_tDBInput_1.getDouble(11);
            if(rs_tDBInput_1.wasNull()){
                    row1.body_weight = null;
            }
		                    }
            ...
            row1.height = rs_tDBInput_1.getDouble(12);
            if(rs_tDBInput_1.wasNull()){
                    row1.height = null;
            }
		                    }
            ...
            row1.waist = rs_tDBInput_1.getDouble(13);
            if(rs_tDBInput_1.wasNull()){
                    row1.waist = null;
            }
		                    }
        	...
        	row1.bp = routines.system.JDBCUtil.getString(rs_tDBInput_1, 14, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 15) {
								row1.lmp = null;
							} else {
										
			row1.lmp = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 15);
		                    }
							if(colQtyInRs_tDBInput_1 < 16) {
								row1.oi_screened = null;
							} else {
	                         		
        	row1.oi_screened = routines.system.JDBCUtil.getString(rs_tDBInput_1, 16, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 17) {
								row1.adr_screened = null;
							} else {
	                         		
        	row1.adr_screened = routines.system.JDBCUtil.getString(rs_tDBInput_1, 17, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 18) {
								row1.adherence_level = null;
							} else {
	                         		
        	row1.adherence_level = routines.system.JDBCUtil.getString(rs_tDBInput_1, 18, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 19) {
								row1.notes = null;
							} else {
	                         		
        	row1.notes = routines.system.JDBCUtil.getString(rs_tDBInput_1, 19, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 20) {
								row1.username = null;
							} else {
	                         		
        	row1.username = routines.system.JDBCUtil.getString(rs_tDBInput_1, 20, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 21) {
								row1.sti_treated = null;
							} else {
	                         		
        	row1.sti_treated = routines.system.JDBCUtil.getString(rs_tDBInput_1, 21, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 22) {
								row1.gestational_age = null;
							} else {
	                         		
        	row1.gestational_age = routines.system.JDBCUtil.getString(rs_tDBInput_1, 22, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 23) {
								row1.maternal_status_art = null;
							} else {
	                         		
        	row1.maternal_status_art = routines.system.JDBCUtil.getString(rs_tDBInput_1, 23, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 24) {
								row1.sti_ids = null;
							} else {
	                         		
        	row1.sti_ids = routines.system.JDBCUtil.getString(rs_tDBInput_1, 24, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 25) {
								row1.archived = null;
							} else {
	                         		
            row1.archived = rs_tDBInput_1.getBoolean(25);
            if(rs_tDBInput_1.wasNull()){
                    row1.archived = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 26) {
								row1.clinic_uuid = null;
							} else {
	                         		
        	row1.clinic_uuid = routines.system.JDBCUtil.getString(rs_tDBInput_1, 26, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 27) {
								row1.pregnant = null;
							} else {
	                         		
            row1.pregnant = rs_tDBInput_1.getBoolean(27);
            if(rs_tDBInput_1.wasNull()){
                    row1.pregnant = null;
            }
		                    }
            ...
            row1.breastfeeding = rs_tDBInput_1.getBoolean(28);
            if(rs_tDBInput_1.wasNull()){
                    row1.breastfeeding = null;
            }
		                    }
            ...
            row1.commence = rs_tDBInput_1.getBoolean(29);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row1.regimen = routines.system.JDBCUtil.getString(rs_tDBInput_1, 30, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 31) {
								row1.regimen_type = null;
							} else {
	                         		
        	row1.regimen_type = routines.system.JDBCUtil.getString(rs_tDBInput_1, 31, false);
		                    }
...
pstmt_tDBOutput_2.setNull(1, java.sql.Types.TIMESTAMP);
                    ...
                    pstmt_tDBOutput_2.setLong(2, visit_create.patient_id);
...
pstmtUpdate_tDBOutput_2.setNull(7 + count_tDBOutput_2, java.sql.Types.TIMESTAMP);
                        ...
                        pstmtUpdate_tDBOutput_2.setLong(8 + count_tDBOutput_2, visit_create.patient_id);
 ...
 */
	...
	final String decryptedPassword_tDBInput_4 = context.LAMIS3_Password; 
		    ...
		    String dbquery_tDBInput_4 = "select c.id, p.uuid, c.date_visit, c.commence, ''  as createdBy, c.archived\nfrom clinic c \njoin patient p on c.patien"
+"t_id = p.id\n--join public.user u on u.user_id = c.user_id\n--where p.facility_id = 2304\n";
        	...
        	row4.uuid = routines.system.JDBCUtil.getString(rs_tDBInput_4, 2, false);
		                    }
							if(colQtyInRs_tDBInput_4 < 3) {
								row4.date_visit = null;
							} else {
										
			row4.date_visit = routines.system.JDBCUtil.getDate(rs_tDBInput_4, 3);
		                    }
							if(colQtyInRs_tDBInput_4 < 4) {
								row4.commence = false;
							} else {
	                         		
            row4.commence = rs_tDBInput_4.getBoolean(4);
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
        	...
        	row4.createdby = routines.system.JDBCUtil.getString(rs_tDBInput_4, 5, false);
		                    }
							if(colQtyInRs_tDBInput_4 < 6) {
								row4.archived = null;
							} else {
	                         		
            row4.archived = rs_tDBInput_4.getBoolean(6);
            if(rs_tDBInput_4.wasNull()){
                    row4.archived = null;
            }
		                    }
...
out1_tmp.form_code = row4.commence ? "0a8b31d2-9397-42f8-9300-688b62c75571" : "5c8741de-f722-4e0a-a505-24e039bf4340" ;
out1_tmp.program_code = "0d31f6ee-571c-45b8-80d5-3f7e1d5377b7";
out1_tmp.created_by = row4.createdby ;
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = clinic_followup_migration.class.getClassLoader().getResourceAsStream("lamis3_etl/clinic_followup_migration_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = clinic_followup_migration.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : clinic_followup_migration");
        }
...
/************************************************************************************************
 *     725580 characters generated by Talend Open Studio for Big Data 
 *     on the June 22, 2021 3:03:55 PM WAT
 ************************************************************************************************/