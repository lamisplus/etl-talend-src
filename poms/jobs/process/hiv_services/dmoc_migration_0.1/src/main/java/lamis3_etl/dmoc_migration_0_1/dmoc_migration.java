	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String url_tDBOutput_2 = "jdbc:postgresql://" + context.LAMISPlus_Server + ":" + context.LAMISPlus_Port
				...
				String insert_tDBOutput_2 = "INSERT INTO \"" + tableName_tDBOutput_2 + "\" (\"" + "date_created"
				...
				String update_tDBOutput_2 = "UPDATE \"" + tableName_tDBOutput_2 + "\" SET \"" + "date_created" + "\" = "
...
// ###############################
				...
				String dbquery_tDBInput_1 = "with dmoc as (SELECT p.uuid as patient_uuid, '' as createdBy, e.date_devolved, e.dmoc_type, \ne.date_next_clinic,\ne.da"
						...
						+ "related_cd4_id)\nselect d.*, r.composition from dmoc d \njoin regimen r on d.regimen_id = r.id::text";
...
// Start of branch "visit_create"
						if (visit_create != null) {
							...
							if (checkCount_tDBOutput_2 > 0) {
								...
								query_tDBOutput_2 = query_tDBOutput_2.append(String.valueOf(visit_create.patient_id))
								...
								if (visit_create.archived == null) {
									...
									pstmtUpdate_tDBOutput_2.setInt(5, visit_create.archived);
								}
								...
								if (visit_create.created_by == null) {
									...
									pstmtUpdate_tDBOutput_2.setString(6, visit_create.created_by);
								}
								...
								if (visit_create.date_visit_start != null) {
									pstmtUpdate_tDBOutput_2.setTimestamp(7 + count_tDBOutput_2,
											new java.sql.Timestamp(visit_create.date_visit_start.getTime()));
								} else {
								...
								pstmtUpdate_tDBOutput_2.setLong(8 + count_tDBOutput_2,
								...
								if (visit_create.date_visit_start != null) {
									pstmtInsert_tDBOutput_2.setTimestamp(1,
											new java.sql.Timestamp(visit_create.date_visit_start.getTime()));
								} else {
								...
								if (visit_create.archived == null) {
									...
									pstmtInsert_tDBOutput_2.setInt(5, visit_create.archived);
								}
								...
								if (visit_create.created_by == null) {
									...
									pstmtInsert_tDBOutput_2.setString(6, visit_create.created_by);
								}
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1
						.prepareStatement("SELECT COUNT(1) FROM \"" + tableName_tDBOutput_1
								+ "\" WHERE \"date_encounter\" = ? AND \"form_code\" = ? AND \"patient_id\" = ? AND \"archived\" = ?");
				resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
				String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"" + "date_created"
						+ "\",\"visit_id\",\"date_encounter\",\"form_code\",\"program_code\",\"created_by\",\"patient_id\",\"organisation_unit_id\",\"archived\") VALUES ("
						+ "now()" + ",?,?,?,?,?,?,?,?)";
				...
				String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1 + "\" SET \"" + "date_created" + "\" = "
						+ "now()"
						+ ",\"visit_id\" = ?,\"date_encounter\" = ?,\"form_code\" = ?,\"program_code\" = ?,\"created_by\" = ?,\"patient_id\" = ?,\"organisation_unit_id\" = ?,\"archived\" = ? WHERE \"date_encounter\" = ? AND \"form_code\" = ? AND \"patient_id\" = ? AND \"archived\" = ?";
...
// ###############################
				...
				String url_tDBInput_4 = "jdbc:postgresql://" + context.LAMIS3_Server + ":" + context.LAMIS3_Port + "/"
						+ context.LAMIS3_Database + "?" + context.LAMIS3_AdditionalParams;
				...
				try {
					...
					while (rs_tDBInput_4.next()) {
						...
						if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
							...
							row5HashKey.date_visit_start = row4.date_devolved == null ? null
									: new java.util.Date(row4.date_devolved.getTime());
						...
						if (tHash_Lookup_row5 != null && tHash_Lookup_row5.getCount(row5HashKey) > 1) { // G 071
							...
							// and it contains more one result from keys : row5.date_visit_start = '" +
							// row5HashKey.date_visit_start + "', row5.uuid = '" + row5HashKey.uuid + "'");
						} // G 071
						...
						if (out1 != null) {
							...
							if (out1.date_encounter != null) {
								pstmt_tDBOutput_1.setTimestamp(1,
										new java.sql.Timestamp(out1.date_encounter.getTime()));
							} else {
							...
							if (out1.form_code == null) {
								...
								pstmt_tDBOutput_1.setString(2, out1.form_code);
							}
							...
							if (checkCount_tDBOutput_1 > 0) {
								...
								if (out1.form_code == null) {
									...
									pstmtUpdate_tDBOutput_1.setString(3, out1.form_code);
								}

								if (out1.program_code == null) {
									pstmtUpdate_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(4, out1.program_code);
								}

								if (out1.created_by == null) {
									pstmtUpdate_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
								} else {
									pstmtUpdate_tDBOutput_1.setString(5, out1.created_by);
								}
								...
								if (out1.date_encounter != null) {
									pstmtUpdate_tDBOutput_1.setTimestamp(9 + count_tDBOutput_1,
											new java.sql.Timestamp(out1.date_encounter.getTime()));
								} else {
								...
								if (out1.form_code == null) {
									...
									pstmtUpdate_tDBOutput_1.setString(10 + count_tDBOutput_1, out1.form_code);
								}
								...
								if (out1.form_code == null) {
									...
									pstmtInsert_tDBOutput_1.setString(3, out1.form_code);
								}

								if (out1.program_code == null) {
									pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(4, out1.program_code);
								}

								if (out1.created_by == null) {
									pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tDBOutput_1.setString(5, out1.created_by);
								}
...
// ###############################      
	...
	public static class form_data_to_createStruct
			implements routines.system.IPersistableRow<form_data_to_createStruct> {
		final static byte[] commonByteArrayLock_LAMIS3_ETL_dmoc_migration = new byte[0];
		static byte[] commonByteArray_LAMIS3_ETL_dmoc_migration = new byte[0];
	...
	public void tDBInput_6Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String url_tDBOutput_4 = "jdbc:postgresql://" + context.LAMISPlus_Server + ":" + context.LAMISPlus_Port
						+ "/" + context.LAMISPlus_Database + "?" + context.LAMISPlus_AdditionalParams;
				...
				String update_tDBOutput_4 = "UPDATE \"" + tableName_tDBOutput_4 + "\" SET \"encounter_id\" = ?,\""
						+ "data" + "\" = " + "?::jsonb" + ",\"organisation_unit_id\" = ? WHERE \"id\" = ?";
				...
				String insert_tDBOutput_3 = "INSERT INTO \"" + tableName_tDBOutput_3
						+ "\" (\"encounter_id\",\"organisation_unit_id\",\"" + "data" + "\") VALUES (?,?," + "?::jsonb"
						+ ")";
...
// ###############################
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File("dmoc_not_migrated.csv")).getAbsolutePath()
						.replace("\\", "/");
...
// ###############################
				...
				String url_tDBInput_6 = "jdbc:postgresql://" + context.LAMIS3_Server + ":" + context.LAMIS3_Port + "/"
						+ context.LAMIS3_Database + "?" + context.LAMIS3_AdditionalParams;
				...
				try {
					...
					while (rs_tDBInput_6.next()) {
						...
						if (!rejectedInnerJoin_tMap_3) { // G_TM_M_020
							...
							row7HashKey.date_encounter = row6.date_devolved == null ? null
									: new java.util.Date(row6.date_devolved.getTime());
						...
						if (tHash_Lookup_row7 != null && tHash_Lookup_row7.getCount(row7HashKey) > 1) { // G 071
							...
							// and it contains more one result from keys : row7.date_encounter = '" +
							// row7HashKey.date_encounter + "', row7.uuid = '" + row7HashKey.uuid + "',
							// row7.archived = '" + row7HashKey.archived + "'");
						} // G 071
						...
						while ((tHash_Lookup_row2 != null && tHash_Lookup_row2.hasNext()) || forceLooprow2) { // G_TM_M_043
							...
							while ((tHash_Lookup_row8 != null && tHash_Lookup_row8.hasNext()) || forceLooprow8) { // G_TM_M_043
								...
								if (tHash_Lookup_row9 != null && tHash_Lookup_row9.getCount(row9HashKey) > 1) { // G 071
									...
									// and it contains more one result from keys : row9.composition = '" +
									// row9HashKey.composition + "'");
								} // G 071
								...
								if (tHash_Lookup_row12 != null && tHash_Lookup_row12.getCount(row12HashKey) > 1) { // G
									...
									// 'row12' and it contains more one result from keys : row12.pharmacy_name = '"
									// + row12HashKey.pharmacy_name + "'");
								} // G 071
...
// Start of branch "form_data_to_create"
								if (form_data_to_create != null) {
									...
									json.put("date_devolved",
											form_data_to_create.date_devolved != null
													? formatter.format(form_data_to_create.date_devolved)
													: JSONObject.NULL);
									json.put("date_next_clinic",
											form_data_to_create.date_next_clinic != null
													? formatter.format(form_data_to_create.date_next_clinic)
													: JSONObject.NULL);
									json.put("date_next_refill",
											form_data_to_create.date_next_refill != null
													? formatter.format(form_data_to_create.date_next_refill)
													: JSONObject.NULL);
									json.put("date_discontinued",
											form_data_to_create.date_discontinued != null
													? formatter.format(form_data_to_create.date_discontinued)
													: JSONObject.NULL);
									json.put("date_last_clinic_stage",
											form_data_to_create.date_last_clinic_stage != null
													? formatter.format(form_data_to_create.date_last_clinic_stage)
													: JSONObject.NULL);
									json.put("date_last_cd4",
											form_data_to_create.date_last_cd4 != null
													? formatter.format(form_data_to_create.date_last_cd4)
													: JSONObject.NULL);
									json.put("date_last_viral_load",
											form_data_to_create.date_last_viral_load != null
													? formatter.format(form_data_to_create.date_last_viral_load)
													: "");
									json.put("date_discontinued",
											form_data_to_create.date_discontinued != null
													? formatter.format(form_data_to_create.date_discontinued)
									...
									if (form_data_to_create.last_clinic_stage != null
											&& form_data_to_create.last_clinic_stage != "") {
									...
									if (tHash_Lookup_row11 != null && tHash_Lookup_row11.getCount(row11HashKey) > 1) { // G
										...
										// System.out.println("WARNING: UNIQUE MATCH is configured for the lookup
										// 'row11' and it contains more one result from keys : row11.encounter_id = '" +
										// row11HashKey.encounter_id + "', row11.backlog_uuid = '" +
										// row11HashKey.backlog_uuid + "'");
									} // G 071
...
// Start of branch "to_update"
									if (to_update != null) {
										...
										if (to_update.encounter_id == null) {
											...
											pstmt_tDBOutput_4.setInt(1, to_update.encounter_id);
										}

										if (to_update.data == null) {
											pstmt_tDBOutput_4.setNull(2, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_4.setString(2, to_update.data);
										}

										if (to_update.organisation_unit_id == null) {
											pstmt_tDBOutput_4.setNull(3, java.sql.Types.INTEGER);
										} else {
											pstmt_tDBOutput_4.setLong(3, to_update.organisation_unit_id);
										}
...
// Start of branch "to_insert"
									if (to_insert != null) {
										...
										if (to_insert.encounter_id == null) {
											...
											pstmt_tDBOutput_3.setInt(1, to_insert.encounter_id);
										}

										if (to_insert.organisation_unit_id == null) {
											pstmt_tDBOutput_3.setNull(2, java.sql.Types.INTEGER);
										} else {
											pstmt_tDBOutput_3.setLong(2, to_insert.organisation_unit_id);
										}

										if (to_insert.data == null) {
											pstmt_tDBOutput_3.setNull(3, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_3.setString(3, to_insert.data);
										}
...
// Start of branch "form_data_reject"
								if (form_data_reject != null) {
									...
									rowtFileOutputDelimited_1[0] = form_data_reject.patient_uuid == null ? null
											: form_data_reject.patient_uuid;
									rowtFileOutputDelimited_1[1] = form_data_reject.reason == null ? null
											: form_data_reject.reason;
...
// ###############################      
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tDBInput_2 - inputs:(after_tDBInput_6) outputs:(row2,row2) |
				// target node:tAdvancedHash_row2 - inputs:(row2) outputs:()
				// linked node: tMap_3 - inputs:(row6,row2,row7,row8,row9,row12)
				// outputs:(form_data_to_create,form_data_reject)
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (colQtyInRs_tDBInput_2 < 1) {
							...
							row2.clinic_application_codeset = routines.system.JDBCUtil.getString(rs_tDBInput_2, 1,
									false);
						}
	...
	public void tDBInput_7Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tDBInput_7 - inputs:(after_tDBInput_6) outputs:(row7,row7) |
	...
	public void tDBInput_8Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tDBInput_8 - inputs:(after_tDBInput_6) outputs:(row8,row8) |
	...
	public void tDBInput_9Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tDBInput_9 - inputs:(after_tDBInput_6) outputs:(row9,row9) |
	...
	public void tDBInput_10Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tDBInput_10 - inputs:() outputs:(row11,row11) | target
				...
				String url_tDBInput_10 = "jdbc:postgresql://" + context.LAMISPlus_Server + ":" + context.LAMISPlus_Port
						+ "/" + context.LAMISPlus_Database + "?" + context.LAMISPlus_AdditionalParams;
	...
	public void tDBInput_11Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tDBInput_11 - inputs:(after_tDBInput_6) outputs:(row12,row12) |
				...
				String url_tDBInput_11 = "jdbc:postgresql://" + context.LAMISPlus_Server + ":" + context.LAMISPlus_Port
						+ "/" + context.LAMISPlus_Database + "?" + context.LAMISPlus_AdditionalParams;
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = dmoc_migration.class.getClassLoader()
					.getResourceAsStream("lamis3_etl/dmoc_migration_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = dmoc_migration.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : dmoc_migration");
		}
...
/************************************************************************************************
 * 429742 characters generated by Talend Open Studio for Big Data on the May 28,
 * 2021 4:00:17 PM WAT
 ************************************************************************************************/