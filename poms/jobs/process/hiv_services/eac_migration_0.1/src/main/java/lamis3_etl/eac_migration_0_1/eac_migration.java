...
package lamis3_etl.eac_migration_0_1;
...
/**
 * Job: eac_migration Purpose: To migrate EAC records<br>
 * Description: To migrate EAC records <br>
 * @author deborah.obanisola@thepalladiumgroup.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class eac_migration implements TalendJob {
...
public String getLAMISPlus_Port(){
	...
	private final String jobName = "eac_migration";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				eac_migration.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(eac_migration.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
System.out.println("****************EAC MIGRATION****************");
System.out.println("To migrate EAC records the following tables will be affected on LAMISPlus:");
...
public static class visit_createStruct implements routines.system.IPersistableRow<visit_createStruct> {
    final static byte[] commonByteArrayLock_LAMIS3_ETL_eac_migration = new byte[0];
    static byte[] commonByteArray_LAMIS3_ETL_eac_migration = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_LAMIS3_ETL_eac_migration.length) {
				if(length < 1024 && commonByteArray_LAMIS3_ETL_eac_migration.length == 0) {
   					commonByteArray_LAMIS3_ETL_eac_migration = new byte[1024];
				} else {
   					commonByteArray_LAMIS3_ETL_eac_migration = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_LAMIS3_ETL_eac_migration, 0, length);
			strReturn = new String(commonByteArray_LAMIS3_ETL_eac_migration, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_LAMIS3_ETL_eac_migration) {
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    static byte[] commonByteArray_LAMIS3_ETL_eac_migration = new byte[0];
			    ...
			    public java.util.Date date_eac1;

				public java.util.Date getDate_eac1 () {
					return this.date_eac1;
				}
				
			    public java.util.Date date_eac2;

				public java.util.Date getDate_eac2 () {
					return this.date_eac2;
				}
				
			    public java.util.Date date_eac3;

				public java.util.Date getDate_eac3 () {
					return this.date_eac3;
				}
		...
		synchronized(commonByteArrayLock_LAMIS3_ETL_eac_migration) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.date_eac1 = readDate(dis);
					
					this.date_eac2 = readDate(dis);
					
					this.date_eac3 = readDate(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// java.util.Date
						...
						writeDate(this.date_eac1,dos);
					
					// java.util.Date
				
						writeDate(this.date_eac2,dos);
					
					// java.util.Date
				
						writeDate(this.date_eac3,dos);
    ...
    public String toString() {
		...
		sb.append(",date_eac1="+String.valueOf(date_eac1));
		sb.append(",date_eac2="+String.valueOf(date_eac2));
		sb.append(",date_eac3="+String.valueOf(date_eac3));
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = context.LAMIS3_Password; 
		    ...
		    String dbquery_tDBInput_1 = "select upper(f.name) as facilityName, p.uuid as patient_uuid, date_eac1, date_eac2, date_eac3, date_sample_collected, n"
+"otes,\ne.date_last_viral_load, ' ' as createdBy, e.archived, e.uuid\nfrom eac e\njoin facility f on e.facility_id = f.id"
+"\njoin patient p on e.patient_id = p.id\n--left join public.user u on u.user_id = e.user_id\n--where f.id = 2304\n";
        	...
        	row1.facilityname = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 2) {
								row1.patient_uuid = null;
							} else {
	                         		
        	row1.patient_uuid = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row1.date_eac1 = null;
							} else {
										
			row1.date_eac1 = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 3);
		                    }
							if(colQtyInRs_tDBInput_1 < 4) {
								row1.date_eac2 = null;
							} else {
										
			row1.date_eac2 = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 4);
		                    }
							if(colQtyInRs_tDBInput_1 < 5) {
								row1.date_eac3 = null;
							} else {
										
			row1.date_eac3 = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 5);
		                    }
							if(colQtyInRs_tDBInput_1 < 6) {
								row1.date_sample_collected = null;
							} else {
										
			row1.date_sample_collected = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 6);
		                    }
			...
			row1.date_last_viral_load = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 8);
		                    }
							if(colQtyInRs_tDBInput_1 < 9) {
								row1.createdby = null;
							} else {
	                         		
        	row1.createdby = routines.system.JDBCUtil.getString(rs_tDBInput_1, 9, false);
		                    }
...
visit_create_tmp.date_visit_start = row1.date_eac1;
visit_create_tmp.date_visit_end = row1.date_eac1;
 ...
 */
	...
	final String decryptedPassword_tDBInput_4 = context.LAMIS3_Password; 
		    ...
		    String dbquery_tDBInput_4 = "select upper(f.name) as facilityName, p.uuid as patient_uuid, date_eac1, date_eac2, date_eac3, date_sample_collected, n"
+"otes,\ne.date_last_viral_load, '' as createdBy, e.archived, e.uuid\nfrom eac e\njoin facility f on e.facility_id = f.id"
+"\njoin patient p on e.patient_id = p.id\n--left join public.user u on u.user_id = e.user_id\n--where f.id = 2304\n";
		    ...
		    while (rs_tDBInput_4.next()) {
		        nb_line_tDBInput_4++;
							...
							if(colQtyInRs_tDBInput_4 < 1) {
								row4.facilityname = null;
							} else {
	                         		
        	row4.facilityname = routines.system.JDBCUtil.getString(rs_tDBInput_4, 1, false);
		                    }
							if(colQtyInRs_tDBInput_4 < 2) {
								row4.patient_uuid = null;
							} else {
	                         		
        	row4.patient_uuid = routines.system.JDBCUtil.getString(rs_tDBInput_4, 2, false);
		                    }
							if(colQtyInRs_tDBInput_4 < 3) {
								row4.date_eac1 = null;
							} else {
										
			row4.date_eac1 = routines.system.JDBCUtil.getDate(rs_tDBInput_4, 3);
		                    }
							if(colQtyInRs_tDBInput_4 < 4) {
								row4.date_eac2 = null;
							} else {
										
			row4.date_eac2 = routines.system.JDBCUtil.getDate(rs_tDBInput_4, 4);
		                    }
							if(colQtyInRs_tDBInput_4 < 5) {
								row4.date_eac3 = null;
							} else {
										
			row4.date_eac3 = routines.system.JDBCUtil.getDate(rs_tDBInput_4, 5);
		                    }
							if(colQtyInRs_tDBInput_4 < 6) {
								row4.date_sample_collected = null;
							} else {
										
			row4.date_sample_collected = routines.system.JDBCUtil.getDate(rs_tDBInput_4, 6);
		                    }
			...
			row4.date_last_viral_load = routines.system.JDBCUtil.getDate(rs_tDBInput_4, 8);
		                    }
							if(colQtyInRs_tDBInput_4 < 9) {
								row4.createdby = null;
							} else {
	                         		
        	row4.createdby = routines.system.JDBCUtil.getString(rs_tDBInput_4, 9, false);
		                    }
 					    ...
 					    boolean forceLooprow5 = false;
 							...
 							row5Struct row5ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row5HashKey.date_visit_start = row4.date_eac1 == null ? null : new java.util.Date(row4.date_eac1.getTime());
...
out1_tmp.form_code = "e856bdfc-16e0-413e-aab1-afbe5c717caf";
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("eac_not_migrated.csv")).getAbsolutePath().replace("\\","/");
 ...
 */
	...
	final String decryptedPassword_tDBInput_6 = context.LAMIS3_Password; 
		    ...
		    String dbquery_tDBInput_6 = "select upper(f.name) as facilityName, p.uuid as patient_uuid, date_eac1, date_eac2, date_eac3, date_sample_collected, n"
+"otes,\ne.date_last_viral_load, '' as createdBy, e.archived, e.uuid\nfrom eac e\njoin facility f on e.facility_id = f.id"
+"\njoin patient p on e.patient_id = p.id\n--left join public.user u on u.user_id = e.user_id\n--where f.id = 2304\n";
        	...
        	row6.facilityname = routines.system.JDBCUtil.getString(rs_tDBInput_6, 1, false);
		                    }
							if(colQtyInRs_tDBInput_6 < 2) {
								row6.patient_uuid = null;
							} else {
	                         		
        	row6.patient_uuid = routines.system.JDBCUtil.getString(rs_tDBInput_6, 2, false);
		                    }
							if(colQtyInRs_tDBInput_6 < 3) {
								row6.date_eac1 = null;
							} else {
										
			row6.date_eac1 = routines.system.JDBCUtil.getDate(rs_tDBInput_6, 3);
		                    }
							if(colQtyInRs_tDBInput_6 < 4) {
								row6.date_eac2 = null;
							} else {
										
			row6.date_eac2 = routines.system.JDBCUtil.getDate(rs_tDBInput_6, 4);
		                    }
							if(colQtyInRs_tDBInput_6 < 5) {
								row6.date_eac3 = null;
							} else {
										
			row6.date_eac3 = routines.system.JDBCUtil.getDate(rs_tDBInput_6, 5);
		                    }
							if(colQtyInRs_tDBInput_6 < 6) {
								row6.date_sample_collected = null;
							} else {
										
			row6.date_sample_collected = routines.system.JDBCUtil.getDate(rs_tDBInput_6, 6);
		                    }
			...
			row6.date_last_viral_load = routines.system.JDBCUtil.getDate(rs_tDBInput_6, 8);
		                    }
							if(colQtyInRs_tDBInput_6 < 9) {
								row6.createdby = null;
							} else {
	                         		
        	row6.createdby = routines.system.JDBCUtil.getString(rs_tDBInput_6, 9, false);
		                    }
 					    ...
 					    boolean forceLooprow7 = false;
 							...
 							row7Struct row7ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_3 = false;
                        		    		    ...
                        		    		    row7HashKey.date_encounter = row6.date_eac1 == null ? null : new java.util.Date(row6.date_eac1.getTime());
...
form_data_to_create_tmp.date_eac1 = row6.date_eac1 ;
form_data_to_create_tmp.date_eac2 = row6.date_eac2 ;
form_data_to_create_tmp.date_eac3 = row6.date_eac3 ;
form_data_to_create_tmp.date_sample_collected = row6.date_sample_collected ;
...
json.put("date_eac1", form_data_to_create.date_eac1 != null ? formatter.format(form_data_to_create.date_eac1) : JSONObject.NULL);
json.put("date_eac2", form_data_to_create.date_eac2 != null ? formatter.format(form_data_to_create.date_eac2) : JSONObject.NULL);
json.put("date_eac3", form_data_to_create.date_eac3 != null ? formatter.format(form_data_to_create.date_eac3) : JSONObject.NULL);
json.put("date_eac1_completion", form_data_to_create.date_eac1 != null ? formatter.format(form_data_to_create.date_eac1) : JSONObject.NULL);
json.put("date_eac2_completion", form_data_to_create.date_eac2 != null ? formatter.format(form_data_to_create.date_eac2) : JSONObject.NULL);
json.put("date_eac3_completion", form_data_to_create.date_eac3 != null ? formatter.format(form_data_to_create.date_eac3) : JSONObject.NULL);
json.put("date_sample_collected", form_data_to_create.date_sample_collected != null ? formatter.format(form_data_to_create.date_sample_collected) : JSONObject.NULL);
...
System.out.println("*******************EAC MIGRATION COMPLETED*********************************");

System.out.println("*****************************************************");
System.out.println("Check ./eac_not_migrated.csv for records that did not migrate. ");
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row7";
		...
		int tos_count_tAdvancedHash_row7 = 0;
			   		...
			   		// linked node: tMap_3 - inputs:(row6,row7) outputs:(form_data_to_create,form_data_reject)
...
+"nt p on v.patient_id = p.id\nleft join organisation_unit o on o.id = v.organisation_unit_id\nwhere v.form_code = 'e856bd"
+"fc-16e0-413e-aab1-afbe5c717caf'";
...
+"counter_id = e.id and e.form_code = 'e856bdfc-16e0-413e-aab1-afbe5c717caf'";
 ...
 */
    ...
    public static void main(String[] args){
        final eac_migration eac_migrationClass = new eac_migration();

        int exitCode = eac_migrationClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = eac_migration.class.getClassLoader().getResourceAsStream("lamis3_etl/eac_migration_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = eac_migration.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : eac_migration");
        }
...
/************************************************************************************************
 *     337068 characters generated by Talend Open Studio for Big Data 
 *     on the June 22, 2021 3:04:30 PM WAT
 ************************************************************************************************/