...
package lamis3_etl.facility_migration_0_1;
...
/**
 * Job: facility_migration Purpose: To migrate all facilities<br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class facility_migration implements TalendJob {
	...
	private final String jobName = "facility_migration";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					facility_migration.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(facility_migration.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				System.out.println("****************FACILITY MIGRATION****************");
				System.out.println("Facility migration starting...");
				System.out.println("Facility migration started...");
	...
	public static class facility_to_createStruct implements routines.system.IPersistableRow<facility_to_createStruct> {
		final static byte[] commonByteArrayLock_LAMIS3_ETL_facility_migration = new byte[0];
		static byte[] commonByteArray_LAMIS3_ETL_facility_migration = new byte[0];
		...
		public Integer organisation_unit_level_id;

		public Integer getOrganisation_unit_level_id() {
			return this.organisation_unit_level_id;
		}

		public long parent_organisation_unit_id;

		public long getParent_organisation_unit_id() {
			return this.parent_organisation_unit_id;
		}
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LAMIS3_ETL_facility_migration.length) {
					if (length < 1024 && commonByteArray_LAMIS3_ETL_facility_migration.length == 0) {
						commonByteArray_LAMIS3_ETL_facility_migration = new byte[1024];
					} else {
						commonByteArray_LAMIS3_ETL_facility_migration = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LAMIS3_ETL_facility_migration, 0, length);
				strReturn = new String(commonByteArray_LAMIS3_ETL_facility_migration, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LAMIS3_ETL_facility_migration) {
				...
				try {
					...
					this.organisation_unit_level_id = readInteger(dis);

					this.parent_organisation_unit_id = dis.readLong();
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.organisation_unit_level_id, dos);

				// long

				dos.writeLong(this.parent_organisation_unit_id);
		...
		public String toString() {
			...
			sb.append(",organisation_unit_level_id=" + String.valueOf(organisation_unit_level_id));
			sb.append(",parent_organisation_unit_id=" + String.valueOf(parent_organisation_unit_id));
		 ...
		 * Compare keys
		 */
		public int compareTo(facility_to_createStruct other) {
	...
	public static class not_createdStruct implements routines.system.IPersistableRow<not_createdStruct> {
		final static byte[] commonByteArrayLock_LAMIS3_ETL_facility_migration = new byte[0];
		static byte[] commonByteArray_LAMIS3_ETL_facility_migration = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(not_createdStruct other) {
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				not_createdStruct not_created = new not_createdStruct();
				facility_to_createStruct facility_to_create = new facility_to_createStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "facility_to_create");
				}
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = ("organisation_unit");
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "\".\"" + ("organisation_unit");
				}
				...
				java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1
						.prepareStatement("SELECT COUNT(1) FROM \"" + tableName_tDBOutput_1 + "\" WHERE \"name\" = ?");
				resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
				String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1
						+ "\" (\"name\",\"description\",\"organisation_unit_level_id\",\"parent_organisation_unit_id\",\"archived\") VALUES (?,?,?,?,?)";
				...
				String update_tDBOutput_1 = "UPDATE \"" + tableName_tDBOutput_1
						+ "\" SET \"name\" = ?,\"description\" = ?,\"organisation_unit_level_id\" = ?,\"parent_organisation_unit_id\" = ?,\"archived\" = ? WHERE \"name\" = ?";
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "not_created");
				}
...
// # Outputs initialization
				facility_to_createStruct facility_to_create_tmp = new facility_to_createStruct();
// ###############################
...
// ###############################
// # Outputs initialization
				not_createdStruct not_created_tmp = new not_createdStruct();
// ###############################
				...
				String dbquery_tDBInput_1 = "select distinct  f.id as facility_id, upper(f.name) as facility_name , upper(l.name) as lga_name, f.id \nfrom facility "
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 1) {
							...
							row1.facility_id = rs_tDBInput_1.getLong(1);
						...
						if (colQtyInRs_tDBInput_1 < 2) {
							...
							row1.facility_name = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
						}
						if (colQtyInRs_tDBInput_1 < 3) {
							row1.lga_name = null;
						} else {

							row1.lga_name = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
						}
						if (colQtyInRs_tDBInput_1 < 4) {
							row1.id = 0;
						} else {

							row1.id = rs_tDBInput_1.getLong(4);
							if (rs_tDBInput_1.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						...
						if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
							...
							row2HashKey.facility_name = row1.facility_name;
...
// # Output reject table : 'not_created'
// # Filter conditions 
							if (rejectedInnerJoin_tMap_1) {
								not_created_tmp.facility_name = row1.facility_name;
								not_created_tmp.lga_name = row1.lga_name;
								not_created_tmp.id = row1.id;
								not_created_tmp.facility_id = row1.facility_id;
								not_created = not_created_tmp;
...
// Start of branch "not_created"
						if (not_created != null) {
							...
							if (execStat) {
								runStat.updateStatOnConnection(iterateId, 1, 1, "not_created");
							}
							...
							if (!rejectedInnerJoin_tMap_2) { // G_TM_M_020
								...
								row3HashKey.lga_name = not_created.lga_name;
							...
							if (tHash_Lookup_row3 != null && tHash_Lookup_row3.getCount(row3HashKey) > 1) { // G 071
								...
								// and it contains more one result from keys : row3.lga_name = '" +
								// row3HashKey.lga_name + "'");
							} // G 071
							...
							{ // start of Var scope
								...
								facility_to_create = null;

// # Output table : 'facility_to_create'
								facility_to_create_tmp.name = not_created.facility_name;
								facility_to_create_tmp.description = not_created.facility_name;
								facility_to_create_tmp.organisation_unit_level_id = 4;
								facility_to_create_tmp.parent_organisation_unit_id = row3.id;
								facility_to_create_tmp.archived = 0;
								facility_to_create = facility_to_create_tmp;
// ###############################
							 ...
							 */
// Start of branch "facility_to_create"
							if (facility_to_create != null) {
								...
								if (execStat) {
									runStat.updateStatOnConnection(iterateId, 1, 1, "facility_to_create");
								}

								whetherReject_tDBOutput_1 = false;
								if (facility_to_create.name == null) {
									pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(1, facility_to_create.name);
								}
								...
								if (checkCount_tDBOutput_1 > 0) {
									if (facility_to_create.name == null) {
										...
										pstmtUpdate_tDBOutput_1.setString(1, facility_to_create.name);
									}

									if (facility_to_create.description == null) {
										pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(2, facility_to_create.description);
									}

									if (facility_to_create.organisation_unit_level_id == null) {
										pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
									} else {
										pstmtUpdate_tDBOutput_1.setInt(3,
												facility_to_create.organisation_unit_level_id);
									}

									pstmtUpdate_tDBOutput_1.setLong(4, facility_to_create.parent_organisation_unit_id);

									if (facility_to_create.archived == null) {
										pstmtUpdate_tDBOutput_1.setNull(5, java.sql.Types.INTEGER);
									} else {
										pstmtUpdate_tDBOutput_1.setInt(5, facility_to_create.archived);
									}

									if (facility_to_create.name == null) {
										pstmtUpdate_tDBOutput_1.setNull(6 + count_tDBOutput_1, java.sql.Types.VARCHAR);
									} else {
										pstmtUpdate_tDBOutput_1.setString(6 + count_tDBOutput_1,
												facility_to_create.name);
									}
									...
									if (facility_to_create.name == null) {
										...
										pstmtInsert_tDBOutput_1.setString(1, facility_to_create.name);
									}

									if (facility_to_create.description == null) {
										pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmtInsert_tDBOutput_1.setString(2, facility_to_create.description);
									}
									...
									pstmtInsert_tDBOutput_1.setLong(4, facility_to_create.parent_organisation_unit_id);

									if (facility_to_create.archived == null) {
										pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.INTEGER);
									} else {
										pstmtInsert_tDBOutput_1.setInt(5, facility_to_create.archived);
									}
							...
							} // End of branch "facility_to_create"
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "not_created");
				}
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "facility_to_create");
				}
	...
	public void tJava_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				System.out.println("facility records created");
				...
				int inserts = globalMap.get("tDBOutput_1_NB_LINE_INSERTED") != null
						...
						: 0;
				System.out.println("Total facility records created - " + inserts);
				System.out.println("Total facility records updated - " + updates);
				System.out.println("Total records fetched from LAMIS3 DB - " + globalMap.get("tDBInput_1_NB_LINE"));

				System.out.println("*******************FACILITY MIGRATION COMPLETED*********************************");
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// linked node: tMap_1 - inputs:(row1,row2) outputs:(not_created)
	...
	public static class row3Struct implements routines.system.IPersistableComparableLookupRow<row3Struct> {
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + ((this.lga_name == null) ? 0 : this.lga_name.hashCode());
		...
		public boolean equals(Object obj) {
			...
			if (this.lga_name == null) {
				if (other.lga_name != null)
					return false;

			} else if (!this.lga_name.equals(other.lga_name))
		...
		public int compareTo(row3Struct other) {
			...
			returnValue = checkNullsAndCompare(this.lga_name, other.lga_name);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public void tDBInput_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// linked node: tMap_2 - inputs:(not_created,row3) outputs:(facility_to_create)
				...
				String dbquery_tDBInput_3 = "select l.id, upper(l.name) as lga_name \nfrom organisation_unit l \ninner join organisation_unit s on l.parent_organisa"
				...
				try {
					...
					while (rs_tDBInput_3.next()) {
						...
						if (colQtyInRs_tDBInput_3 < 2) {
							...
							row3.lga_name = routines.system.JDBCUtil.getString(rs_tDBInput_3, 2, false);
						}
	...
	public static void main(String[] args) {
		final facility_migration facility_migrationClass = new facility_migration();

		int exitCode = facility_migrationClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = facility_migration.class.getClassLoader()
					.getResourceAsStream("lamis3_etl/facility_migration_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = facility_migration.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : facility_migration");
		}
...
/************************************************************************************************
 * 119755 characters generated by Talend Open Studio for Big Data on the May 27,
 * 2021 11:40:41 AM WAT
 ************************************************************************************************/