...
// ###############################
				...
				String dbquery_tDBInput_8 = "with pharmacy_records as (select *\n	from pharmacy, jsonb_to_recordset(lines) as x(\n	morning text,\n	duration text,\n	"
						...
						+ "id,r.description, r.composition, d.name, regexp_replace(d.strength, '[^0-9]+', '') as strength, upper(f.name) as facilit"
						+ "yName, u.username as createdBy \nfrom pharmacy_records l\njoin regimen r on r.id = l.regimen_id::int\n	join regimen_drug"
						+ " rd on rd.id = l.regimen_drug_id::int\n	join drug d on d.id = rd.drug_id\n	join patient p on p.id = l.patient_id\n	left "
				...
				try {
					...
					while (rs_tDBInput_8.next()) {
						...
						if (colQtyInRs_tDBInput_8 < 6) {
							...
							row6.last_modified = routines.system.JDBCUtil.getDate(rs_tDBInput_8, 6);
						}
						if (colQtyInRs_tDBInput_8 < 7) {
							row6.user_id = null;
						} else {

							row6.user_id = rs_tDBInput_8.getLong(7);
							if (rs_tDBInput_8.wasNull()) {
								row6.user_id = null;
							}
						}
						if (colQtyInRs_tDBInput_8 < 8) {
							...
							row6.mmd_type = routines.system.JDBCUtil.getString(rs_tDBInput_8, 8, false);
						}
						if (colQtyInRs_tDBInput_8 < 9) {
							row6.archived = null;
						} else {

							row6.archived = rs_tDBInput_8.getBoolean(9);
							if (rs_tDBInput_8.wasNull()) {
								row6.archived = null;
							}
						}
						if (colQtyInRs_tDBInput_8 < 10) {
							...
							row6.uuid = routines.system.JDBCUtil.getString(rs_tDBInput_8, 10, false);
						}
						if (colQtyInRs_tDBInput_8 < 11) {
							row6.adr_screened = null;
						} else {

							row6.adr_screened = rs_tDBInput_8.getBoolean(11);
							if (rs_tDBInput_8.wasNull()) {
								row6.adr_screened = null;
							}
						}
						if (colQtyInRs_tDBInput_8 < 12) {
							...
							row6.adherence = rs_tDBInput_8.getBoolean(12);
							if (rs_tDBInput_8.wasNull()) {
								row6.adherence = null;
							}
						}
						if (colQtyInRs_tDBInput_8 < 13) {
							...
							row6.prescription_error = rs_tDBInput_8.getBoolean(13);
							if (rs_tDBInput_8.wasNull()) {
								row6.prescription_error = null;
							}
						}
						if (colQtyInRs_tDBInput_8 < 14) {
							...
							row6.extra = routines.system.JDBCUtil.getString(rs_tDBInput_8, 14, false);
						}
						if (colQtyInRs_tDBInput_8 < 15) {
							row6.lines = null;
						} else {

							row6.lines = routines.system.JDBCUtil.getString(rs_tDBInput_8, 15, false);
						}
						if (colQtyInRs_tDBInput_8 < 16) {
							row6.adverse_drug_reactions = null;
						} else {

							row6.adverse_drug_reactions = routines.system.JDBCUtil.getString(rs_tDBInput_8, 16, false);
						}
						if (colQtyInRs_tDBInput_8 < 17) {
							row6.morning = null;
						} else {

							row6.morning = routines.system.JDBCUtil.getString(rs_tDBInput_8, 17, false);
						}
						if (colQtyInRs_tDBInput_8 < 18) {
							row6.duration = null;
						} else {

							row6.duration = routines.system.JDBCUtil.getString(rs_tDBInput_8, 18, false);
						}
						if (colQtyInRs_tDBInput_8 < 19) {
							row6.afternoon = null;
						} else {

							row6.afternoon = routines.system.JDBCUtil.getString(rs_tDBInput_8, 19, false);
						}
						if (colQtyInRs_tDBInput_8 < 20) {
							row6.regimen_id = null;
						} else {

							row6.regimen_id = routines.system.JDBCUtil.getString(rs_tDBInput_8, 20, false);
						}
						if (colQtyInRs_tDBInput_8 < 21) {
							row6.regimen_drug_id = null;
						} else {

							row6.regimen_drug_id = routines.system.JDBCUtil.getString(rs_tDBInput_8, 21, false);
						}
						if (colQtyInRs_tDBInput_8 < 22) {
							row6.regimen_type_id = null;
						} else {

							row6.regimen_type_id = routines.system.JDBCUtil.getString(rs_tDBInput_8, 22, false);
						}
						if (colQtyInRs_tDBInput_8 < 23) {
							row6.patient_uuid = null;
						} else {

							row6.patient_uuid = routines.system.JDBCUtil.getString(rs_tDBInput_8, 23, false);
						}
						if (colQtyInRs_tDBInput_8 < 24) {
							row6.description = null;
						} else {

							row6.description = routines.system.JDBCUtil.getString(rs_tDBInput_8, 24, false);
						}
						if (colQtyInRs_tDBInput_8 < 25) {
							row6.composition = null;
						} else {

							row6.composition = routines.system.JDBCUtil.getString(rs_tDBInput_8, 25, false);
						}
						if (colQtyInRs_tDBInput_8 < 26) {
							row6.name = null;
						} else {

							row6.name = routines.system.JDBCUtil.getString(rs_tDBInput_8, 26, false);
						}
						if (colQtyInRs_tDBInput_8 < 27) {
							row6.strength = null;
						} else {

							row6.strength = routines.system.JDBCUtil.getString(rs_tDBInput_8, 27, false);
						}
						if (colQtyInRs_tDBInput_8 < 28) {
							row6.facilityname = null;
						} else {

							row6.facilityname = routines.system.JDBCUtil.getString(rs_tDBInput_8, 28, false);
						}
						if (colQtyInRs_tDBInput_8 < 29) {
							row6.createdby = null;
						} else {

							row6.createdby = routines.system.JDBCUtil.getString(rs_tDBInput_8, 29, false);
						}
...
// # Filter conditions 
							if (rejectedInnerJoin_tMap_3) {
								...
								form_data_reject_tmp.reason = "Drug does not exist on LAMISPlus";
...
//check if row is a regimen
							if (form_data_to_create.composition != null && form_data_to_create.composition.trim() != ""
								...
								regimenJson.put("regimen", form_data_to_create.regimenName);
								...
								if (obj != null) {
									...
									for (int i = 0, size = rd.length(); i < size; i++) {
										...
										if (obj.get(drug_object.getString("name")) != null) {
...
// Start of branch "to_update"
							if (to_update != null) {
								...
								query_tDBOutput_4 = query_tDBOutput_4.append(updateSQLSplits_tDBOutput_4[0])
										.append(String.valueOf(to_update.id)).append(updateSQLSplits_tDBOutput_4[1]);
								...
								query_tDBOutput_4 = query_tDBOutput_4.append(String.valueOf(to_update.id))
										.append(updateSQLSplits_tDBOutput_4[5]);
...
/************************************************************************************************
 * 273271 characters generated by Talend Open Studio for Big Data on the May 7,
 * 2021 2:54:44 PM WAT
 ************************************************************************************************/